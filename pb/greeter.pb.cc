...
const char descriptor_table_protodef_greeter_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    ...
    "Request\032\021.hello.HelloReply\022;\n\017StreamGree"
    "tings\022\023.hello.HelloRequest\032\021.hello.Hello"
    "Reply0\001b\006proto3"
};
...
PROTOBUF_NDEBUG_INLINE HelloReply::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::hello::HelloReply& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
